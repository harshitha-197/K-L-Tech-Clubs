...
<br>	
   <div class="navbar" align="center">
               <div class="menu" align="center">
                ...
                <a href="adddepartmentbodies.jsp">Add Department Body</a>
                <a href="logout">Logout</a>
               </div>
            </div>	
<section class="gallery">
		<h1>Department Bodies We have</h1>
		<div class="container">
			<div class="row">
				<%
			    ...
			    try {
			      ...
			      PreparedStatement pstmt = con.prepareStatement("select * from deptbodies");
			      ResultSet rs = pstmt.executeQuery();
			      
			      while(rs.next()) {
			    	  String path = "deptinfo.jsp?name="+rs.getString(2);
