...
<body>
<br>   <div class="navbar" align="center">
               <div class="menu" align="center">
                <a href="adminhome.jsp">Home</a>
                <a href="adminclub.jsp">Clubs</a>
                <a href="addhobbyclubs.jsp">Add Club</a>
                <a href="logout">Logout</a>
               </div>
            </div>	
<section class="gallery">
		<h1>Hobby Clubs We have</h1>
		<div class="container">
			<div class="row">
				<%
			    ...
			    try {
			      ...
			      PreparedStatement pstmt = con.prepareStatement("select * from hobbyclubs");
			      ResultSet rs = pstmt.executeQuery();
			      
			      while(rs.next()) {
			    	  String path = "hobbyclubsinfo.jsp?name="+rs.getString(2);
